...
{               ?>   
                          <tr>
                            ...
                            <td><?php  echo htmlentities($row->SubID);?></td>
                            ...
                            <td>
                             <a href="edit-subject-detail.php?editid=<?php echo htmlentities ($row->sid);?>" class="btn btn-primary btn-sm"><i class="icon-eye"></i></a>
                                                 <a href="manage-subject.php?delid=<?php echo ($row->sid);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger btn-sm"> <i class="icon-trash"></i></a>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
...
{               ?>   
    ...
    <!-- container-scroller -->
>>>>>>> 589ace871213ffd29f354b38f6f4b068c8974925:manage-students.php
   <?php }  ?>